...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message buttonTitles:(NSArray *)buttonTitles buttonStyle:(JGActionSheetButtonStyle)buttonStyle {
    ...
    if (self) {
        if (title) {
            ...
            titleLabel.font = [UIFont fontWithName:@"OpenSans" size:16.5];
            ...
            self.backgroundColor = rgba(23, 60, 93, 0.75);
        }
        ...
        if (message) {
            ...
            messageLabel.font = [UIFont fontWithName:@"OpenSans-Bold" size:16.5];
...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message contentView:(UIView *)contentView {
    ...
    if (self) {
        ...
        if (message) {
            ...
            messageLabel.backgroundColor = [UIColor clearColor];
            messageLabel.textAlignment = NSTextAlignmentCenter;
            messageLabel.font = [UIFont fontWithName:@"OpenSansBold" size:16.5];
            messageLabel.textColor = [UIColor whiteColor];
            messageLabel.numberOfLines = 0;
...
- (void)setButtonStyle:(JGActionSheetButtonStyle)buttonStyle forButton:(UIButton *)button {
    ...
    if (buttonStyle == JGActionSheetButtonStyleDefault) {
        font = [UIFont fontWithName:@"OpenSans" size:16.5];
        titleColor = rgb(48, 117, 163);
...
- (CGRect)layoutForWidth:(CGFloat)width {
    ...
    if (self.titleLabel) {
        ...
        if (iOS7) {
            ...
            titleLabelHeight = CGRectGetHeight([self.titleLabel.text boundingRectWithSize:maxLabelSize options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil]);
        }
        else {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
            titleLabelHeight = [self.titleLabel.text sizeWithFont:self.titleLabel.font constrainedToSize:maxLabelSize lineBreakMode:self.titleLabel.lineBreakMode].height;
#pragma clang diagnostic pop
        }
        
        self.titleLabel.frame = (CGRect){{spacing, height}, {width-spacing*2.0f, titleLabelHeight}};
...
- (instancetype)initWithSections:(NSArray *)sections {
    ...
    if (self) {
        ...
        self.backgroundColor = rgba(23, 60, 93, 0.5);
...
- (void)layoutSheetForFrame:(CGRect)frame fitToRect:(BOOL)fitToRect initialSetUp:(BOOL)initial continuous:(BOOL)continuous {
    ...
    CGFloat spacing = 0;// 2.0f*kSpacing;
...
- (void)moveToPoint:(CGPoint)point arrowDirection:(JGActionSheetArrowDirection)arrowDirection animated:(BOOL)animated {
    ...
    void (^changes)(void) = ^{
        ...
        _scrollViewHost.backgroundColor = [UIColor redColor];
