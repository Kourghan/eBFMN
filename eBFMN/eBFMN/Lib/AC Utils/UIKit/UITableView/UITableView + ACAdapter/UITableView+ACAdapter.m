...
- (void)ac_setDidCommitEditingStyle:(ACTableViewCellEditingStyle)commitEditingStyle {
    [self.ac_adapter setCommitEditingStyle:commitEditingStyle];
}

- (void)ac_setTableViewCellEditingStyle:(ACTableViewEditingStyleForRowAtIndexPath)editingStyleFoIndexPath {
    [self.ac_adapter setEditingStyleForIndexPath:editingStyleFoIndexPath];
}
