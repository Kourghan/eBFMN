...
typedef void (^ACTableViewCellEditingStyle)(UITableView *tableView, UITableViewCellEditingStyle editingStyle, NSIndexPath *indexPath, id object);
typedef UITableViewCellEditingStyle (^ACTableViewEditingStyleForRowAtIndexPath)(UITableView *tableView, NSIndexPath *indexPath);
...
@property (nonatomic, copy) ACTableViewCellEditingStyle commitEditingStyle;
@property (nonatomic, copy) ACTableViewEditingStyleForRowAtIndexPath editingStyleForIndexPath;
