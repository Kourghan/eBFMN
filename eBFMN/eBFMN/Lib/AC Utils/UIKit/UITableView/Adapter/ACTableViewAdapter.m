...
- (CGFloat)tableView:(UITableView *)tableView heightForFooterInSection:(NSInteger)section {
    Class<ACTableViewHeaderFooter> class = [_dataSource classForFooterInSection:section];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    Class headerClass = [_dataSource classForFooterInSection:section];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ac_safeBlockCall(_commitEditingStyle, tableView, editingStyle, indexPath, [self.dataSource objectAtIndexPath:indexPath]);
}

- (UITableViewCellEditingStyle)tableView:(UITableView *)tableView editingStyleForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (_editingStyleForIndexPath) {
        return _editingStyleForIndexPath(tableView, indexPath);
    }
    else {
